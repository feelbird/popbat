...
if( !class_exists('Cryptlight_Hooks') ){
	...
	class Cryptlight_Hooks {
		...
		function cryptlight_list_header(){
		    ...
		    $hf_header_array['default'] = esc_html__( 'Default', 'cryptlux' );
		...
		function cryptlight_list_footer(){
		    ...
		    $hf_footer_array['default'] = esc_html__( 'Default', 'cryptlux' );
		...
		function cryptlight_define_layout(){
			return array(
				'layout_1c' => esc_html__('No Sidebar', 'cryptlux'),
				'layout_2r' => esc_html__('Right Sidebar', 'cryptlux'),
				'layout_2l' => esc_html__('Left Sidebar', 'cryptlux'),
			);
		}
		...
		function cryptlight_define_wide_boxed(){
			return array(
				'wide' => esc_html__('Wide', 'cryptlux'),
				'boxed' => esc_html__('Boxed', 'cryptlux'),
			);
		}
