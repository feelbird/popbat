...
if( !class_exists('Cryptlight_Widgets') ){
	...
	class Cryptlight_Widgets {
		...
		function cryptlight_register_widgets() {
		  ...
		  $args_blog = array(
		    'name' => esc_html__( 'Main Sidebar', 'cryptlux'),
		    'id' => "main-sidebar",
		    'description' => esc_html__( 'Main Sidebar', 'cryptlux' ),
		    'class' => '',
		  ...
		  if( cryptlight_is_woo_active() ){
		    $args_woo = array(
		      'name' => esc_html__( 'WooCommerce Sidebar', 'cryptlux'),
		      'id' => "woo-sidebar",
		      'description' => esc_html__( 'WooCommerce Sidebar', 'cryptlux' ),
		      'class' => '',
