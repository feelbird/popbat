...
class Cryptlight_Elementor {
	...
	function cryptlight_add_category(  ) {
	    ...
	    \Elementor\Plugin::instance()->elements_manager->add_category(
	        'hf',
	        [
	            'title' => __( 'Header Footer', 'cryptlux' ),
	            'icon' => 'fa fa-plug',
	        ]
	    );
    ...
    function cryptlight_add_animations(){
    	$animations = array(
            'cryptlux' => array(
                'ova-move-up' 		=> esc_html__('Move Up', 'cryptlux'),
                'ova-move-down' 	=> esc_html__( 'Move Down', 'cryptlux' ),
                'ova-move-left'     => esc_html__('Move Left', 'cryptlux'),
                'ova-move-right'    => esc_html__('Move Right', 'cryptlux'),
                'ova-scale-up'      => esc_html__('Scale Up', 'cryptlux'),
                'ova-flip'          => esc_html__('Flip', 'cryptlux'),
                'ova-helix'         => esc_html__('Helix', 'cryptlux'),
                'ova-popup'			=> esc_html__( 'PopUp','cryptlux' )
            ),
        );
    ...
    function cryptlight_tabs_custom( $element, $args ) {
		...
		$element->start_controls_section(
			...
			[
				...
				'label' => esc_html__( 'Ova Tabs', 'cryptlux' ),
			]
		);
			...
			$element->add_responsive_control(
	            'ova_tabs_display',
	            [
	                'label' 	=> esc_html__( 'Display', 'cryptlux' ),
	                'type' 		=> \Elementor\Controls_Manager::CHOOSE,
	                'options' 	=> [
	                    'inline-block' => [
	                        'title' => esc_html__( 'Inline Block', 'cryptlux' ),
	        ...
	        $element->add_responsive_control(
	            ...
	            [
	                'label' 	=> esc_html__( 'Display Wrapper', 'cryptlux' ),
	                'type' 		=> \Elementor\Controls_Manager::CHOOSE,
	                'options' 	=> [
	                    'block' => [
	                        'title' => esc_html__( 'Block', 'cryptlux' ),
	                        'icon' 	=> 'eicon-h-align-stretch',
	                    ],
	                    'flex' => [
	                        'title' => esc_html__( 'Flex', 'cryptlux' ),
	                        'icon' 	=> 'eicon-h-align-center',
	                    ],
	                    'none' => [
	                        'title' => esc_html__( 'None', 'cryptlux' ),
			...
			$element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Desktop', 'cryptlux' ),
			...
			$element->add_control(
				'ova_tabs_bg_active',
				[
					'label' 	=> esc_html__( 'Background Active', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$element->add_control(
				'ova_tabs_bg_hover',
				[
					'label' 	=> esc_html__( 'Background Hover', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Color Title Desktop', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Color Title Desktop Active', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Mobile', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                	'ova_tabs_display' => 'inline-block',
			...
			$element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Color Title Mobile', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Color Title Mobile Active', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
	        ...
	        $element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Border Desktop', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                	'ova_tabs_display' => 'inline-block',
	        ...
	        $element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Border Color Active', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
	        ...
	        $element->add_responsive_control(
	            ...
	            [
	                'label' 		=> esc_html__( 'First Border Radius', 'cryptlux' ),
	                'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%' ],
	                'selectors' 	=> [
	        ...
	        $element->add_responsive_control(
	            ...
	            [
	                'label' 		=> esc_html__( 'Last Border Radius', 'cryptlux' ),
	                'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%' ],
	                'selectors' 	=> [
	        ...
	        $element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Border Mobile', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                	'ova_tabs_display' => 'inline-block',
			...
			$element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Border Color Active Mobile', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .elementor-tabs .elementor-tabs-content-wrapper .elementor-tab-mobile-title.elementor-active' => 'border-color: {{VALUE}};',
					],
	        ...
	        $element->add_responsive_control(
	            ...
	            [
	                'label' 		=> esc_html__( 'Border Radius Mobile', 'cryptlux' ),
	                'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%' ],
	                'selectors' 	=> [
	        ...
	        $element->add_responsive_control(
	            ...
	            [
	                'label' 		=> esc_html__( 'Padding Mobile', 'cryptlux' ),
	                'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
	        ...
	        $element->add_responsive_control(
	            ...
	            [
	                'label' 		=> esc_html__( 'Margin Mobile', 'cryptlux' ),
	                'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
    ...
    function cryptlight_accordion_custom( $element, $args ) {
		...
		$element->start_controls_section(
			...
			[
				'tab' 	=> \Elementor\Controls_Manager::TAB_STYLE,
				'label' => esc_html__( 'Ova Accordion', 'cryptlux' ),
			]
		);
			...
			$element->add_responsive_control(
	            ...
	            [
	                ...
	                'options' 	=> [
	                    'list-item' => [
	                        'title' => esc_html__( 'List-item', 'cryptlux' ),
	        ...
	        $element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Item Options', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'ova_accordion_display!' => '',
	        ...
	        $element->add_control(
				'marker_options',
				[
					'label' 	=> esc_html__( 'Marker Options', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'ova_accordion_display!' => '',
			...
			$element->add_control(
				'title_options',
				[
					'label' 	=> esc_html__( 'Title Options', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'ova_accordion_display!' => '',
				...
				$element->add_group_control(
					...
					[
						...
						'label' 	=> esc_html__( 'Background Gradient Active', 'cryptlux' ),
						'types' 	=> [ 'classic', 'gradient' ],
						'exclude' 	=> [ 'image' ],
		        ...
		        $element->add_control(
		            ...
		            [
		                'label' 		=> esc_html__( 'Border Radius Active', 'cryptlux' ),
		                'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
		                'size_units' 	=> [ 'px', '%' ],
		                'selectors' 	=> [
		    ...
		    $element->add_control(
				'icon_options',
				[
					'label' 	=> esc_html__( 'Icon Options', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'ova_accordion_display!' => '',
		        ...
		        $element->add_control(
		            ...
		            [
		                'label' 	=> esc_html__( 'Active Background ', 'cryptlux' ),
		                'type' 		=> \Elementor\Controls_Manager::COLOR,
		                'selectors' => [
	        ...
	        $element->add_control(
				'content_options',
				[
					'label' 	=> esc_html__( 'Content Options', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'ova_accordion_display!' => '',
		        ...
		        $element->add_responsive_control(
		            ...
		            [
		                'label' 		=> esc_html__( 'Item Padding', 'cryptlux' ),
		                'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
		                'size_units' 	=> [ 'px', '%', 'em' ],
		                'selectors' 	=> [
		        ...
		        $element->add_responsive_control(
		            'item_content_margin',
		            [
		                'label' 		=> esc_html__( 'Item Margin', 'cryptlux' ),
		                'type' 			=> \Elementor\Controls_Manager::DIMENSIONS,
		                'size_units' 	=> [ 'px', '%', 'em' ],
		                'selectors' 	=> [
    ...
    function cryptlight_toggle_custom( $element, $args ) {
		...
		$element->start_controls_section(
			...
			[
				'tab' 	=> \Elementor\Controls_Manager::TAB_STYLE,
				'label' => esc_html__( 'Ova Toggle', 'cryptlux' ),
			]
		);
			...
			$element->add_control(
				...
				[
					'label' 	=> esc_html__( 'Title Active', 'cryptlux' ),
					'type' 		=> \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
	...
	function cryptlight_social_icons_custom ( $element, $args ) {
		...
		$element->start_controls_section(
			...
			[
				'tab' 	=> \Elementor\Controls_Manager::TAB_STYLE,
				'label' => esc_html__( 'Ova Social Icon', 'cryptlux' ),
			]
		);
