...
function cryptlight_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'                     => esc_html__('Elementor','cryptlux'),
            'slug'                     => 'elementor',
            'required'                 => true,
        ),
        array(
            'name'                     => esc_html__('Contact Form 7','cryptlux'),
            'slug'                     => 'contact-form-7',
            'required'                 => true,
        ),
        array(
            'name'                     => esc_html__('Mailchimp for wp','cryptlux'),
            'slug'                     => 'mailchimp-for-wp',
            'required'                 => true,
        ),
        array(
            'name'                     => esc_html__('Widget importer exporter','cryptlux'),
            'slug'                     => 'widget-importer-exporter',
            'required'                 => true,
        ),
        array(
            'name'                     => esc_html__('One click demo import','cryptlux'),
            'slug'                     => 'one-click-demo-import',
            'required'                 => true,
        ),
        array(
            'name'                     => esc_html__('Elementor Header & Footer Builder','cryptlux'),
    ...
    $config = array(
        'id'           => 'cryptlux',                 // Unique ID for hashing notices for multiple instances of TGMPA.
