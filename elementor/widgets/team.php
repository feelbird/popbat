...
class Cryptlight_Elementor_Team extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Team', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
		    ...
		    $this->add_control(
				'image',
				[
					'label' 	=> esc_html__( 'Image Team', 'cryptlux' ),
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> esc_html__( 'Charlee Mangar', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 		=> Controls_Manager::TEXT,
					'default' 	=> esc_html__( 'CEO & CFO', 'cryptlux' ),
				]
			);
			...
			$repeater->add_control(
				'list_title_icon', [
					'label' 		=> esc_html__( 'Title Icon', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'List Title Icon' , 'cryptlux' ),
					'label_block' 	=> true,
				]
			);
            ...
            $this->add_control(
				'icons',
				[
					'label' 	=> esc_html__( 'Social Icons', 'cryptlux' ),
					'type' 		=> Controls_Manager::REPEATER,
					'fields' 	=> $repeater->get_controls(),
					'default' 	=> [
						[	
							'list_title_icon' 	=> esc_html__( 'Twitter', 'cryptlux' ),
							'class_icon' 		=> esc_html__( 'ovaicon-twitter', 'cryptlux' ),
							'link' 				=> ['url' => '#'],
						],
						[	
							'list_title_icon' 	=> esc_html__( 'Facebook', 'cryptlux' ),
							'class_icon' 		=> esc_html__( 'ovaicon-facebook-logo-1', 'cryptlux' ),
							'link' 				=> ['url' => '#'],
						],
						[	
							'list_title_icon' 	=> esc_html__( 'Linkedin', 'cryptlux' ),
							'class_icon' 		=> esc_html__( 'fab fa-linkedin-in', 'cryptlux' ),
							'link' 				=> ['url' => '#'],
						],
        ...
        $this->start_controls_section(
			'section_style_icon',
			[
				'label' 	=> esc_html__( 'Icons', 'cryptlux' ),
		...
		$this->start_controls_section(
			'section_style_info',
			[
				'label' 	=> esc_html__( 'Info', 'cryptlux' ),
				'tab' 		=> Controls_Manager::TAB_STYLE,
				'condition' => [
					'type' 	=> 'v1',
				],
			...
			$this->start_controls_tabs( 'tabs_info_style' );
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						'color_title',
						[
							'label' 	=> esc_html__( 'Color Title', 'cryptlux' ),
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
					...
					$this->add_control(
						'color_sub-title',
						[
							'label' => esc_html__( 'Color sub-title', 'cryptlux' ),
							'type' => Controls_Manager::COLOR,
							'selectors' => [
					...
					$this->add_control(
						'color_rectangle',
						[
							'label' 	=> esc_html__( 'Color rectangle', 'cryptlux' ),
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							'label' 	=> esc_html__( 'Color subtitle', 'cryptlux' ),
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
		...
		$this->start_controls_section(
	        ...
	        $this->add_control(
	            ...
	            [
	                'label' 	=> esc_html__( 'Background Overlay', 'cryptlux' ),
	                'type' 		=> Controls_Manager::COLOR,
	                'selectors' => [
	...
	protected function render() {
		...
		if ( empty( $alt ) ) {
			$alt = $title ? $title : esc_html__( 'Avatar', 'cryptlux' );
		}
		...
		$target 	= ( 'on' == $settings['link_team']['is_external'] ) ? ' ' : '';
		?>
			...
			<div class="ova-team-v2">
				...
				<ul class="social-list">
					<?php foreach( $icons as $icon ): 
						$link 	= $icon['link']['url'];
						$target = ( 'on' == $icon['link']['is_external'] ) ? ' ' : '';
					?>
						<li class="social">
							<?php if ( ! empty( $link ) ): ?>
								<a href="<?php echo esc_url( $link );?>"<?php echo esc_attr( $target ); ?>>
