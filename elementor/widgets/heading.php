...
class Cryptlight_Elementor_Heading extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Heading', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_heading',
			[
				'label' => esc_html__( 'Heading', 'cryptlux' ),
			]
		);	
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> esc_html__( 'Add Your Heading', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				'bg_title',
				[
					'label' 	=> esc_html__( 'Background Title', 'cryptlux' ),
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and typesetting industry', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				'header_size',
				[
					'label' 	=> esc_html__( 'HTML Tag', 'cryptlux' ),
			...
			$this->add_responsive_control(
				...
				[
					...
					'options' 	=> [
						...
						'justify' => [
							'title' => esc_html__( 'Justified', 'cryptlux' ),
			...
			$this->add_control(
				...
				[
					...
					'type' 		=> Controls_Manager::SELECT,
					'options' 	=> [
						'ova_before' 	=> esc_html__( 'Before', 'cryptlux' ),
						'ova_after' 	=> esc_html__( 'After', 'cryptlux' ),
						'ova_top' 		=> esc_html__( 'Top', 'cryptlux' ),
						'ova_botton' 	=> esc_html__( 'Buttom', 'cryptlux' ),
						'ova_both' 		=> esc_html__( 'Both', 'cryptlux' ),
					],
					'default' 	=> 'ova_before',
					'condition' => [
						'show_line' => 'yes',
		...
		$this->start_controls_section(
	        ...
	        $this->add_group_control(
				...
				[
					'name' 		=> 'text_shadow',
					'label' 	=> esc_html__( 'Text Shadow', 'cryptlux' ),
					'selector' 	=> '{{WRAPPER}} .ova-heading',
				]
			);
		...
		$this->start_controls_section(
	        ...
	        $this->add_responsive_control(
	            'line_margin_before',
	            [
	                'label' 		=> esc_html__( 'Margin Before', 'cryptlux' ),
	                'type' 			=> Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
	        ...
	        $this->add_responsive_control(
	            'line_margin_after',
	            [
	                'label' 		=> esc_html__( 'Margin After', 'cryptlux' ),
	                'type' 			=> Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
