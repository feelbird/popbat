...
class Cryptlight_Elementor_Details extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Details', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Details', 'cryptlux' ),
			]
		);	
			...
			$this->add_control(
				...
				[
					...
					'row' 		=> 5,
					'default' 	=> esc_html__('Munber of tokens for sale','cryptlux'),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'row' 		=> 5,
					'default' 	=> esc_html__('900.0000 ICC (9%)','cryptlux'),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'title' 		=> esc_html__( '28%', 'cryptlux' ),
							'description' 	=> esc_html__( 'Mobile ad Platform', 'cryptlux' ),
						],
						[
							'title' 		=> esc_html__( '18%', 'cryptlux' ),
							'description' 	=> esc_html__( 'Marketing & General', 'cryptlux' ),
						],
						[
							'title' 		=> esc_html__( '22%', 'cryptlux' ),
							'description' 	=> esc_html__( 'Reward Program', 'cryptlux' ),
						],
						[
							'title' 		=> esc_html__( '25%', 'cryptlux' ),
							'description' 	=> esc_html__( 'Promotion/Marketing', 'cryptlux' ),
						],
						[
							'title' 		=> esc_html__( '10%', 'cryptlux' ),
							'description' 	=> esc_html__( 'Team & Advisor', 'cryptlux' ),
						],
					],
					'title_field' 	=> '{{{ title }}}',
					'condition'		=> [
            ...
            $this->add_control(
	            ...
	            [
	                ...
	                'type' 		=> Controls_Manager::SELECT,
	                'options' 	=> [
	                    'column1' => esc_html__( 'Column 1', 'cryptlux' ),
	                    'column2' => esc_html__( 'Column 2', 'cryptlux' ),
	                    'column3' => esc_html__( 'Column 3', 'cryptlux' ),
	                    'column4' => esc_html__( 'Column 4', 'cryptlux' ),
	                    'column5' => esc_html__( 'Column 5', 'cryptlux' ),
	                ],
	                'default' 	=> 'column2',
	                'condition' => [
	                	'type' 	=> 'v3',
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'line_option',
				[
					'label' 	=> esc_html__( 'Line Option', 'cryptlux' ),
