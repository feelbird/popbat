...
class Cryptlight_Elementor_Icon_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Icon List', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'title' 	=> esc_html__( 'White Paper', 'cryptlux' ),
							'icon' 		=> esc_html__( 'fas fa-check', 'cryptlux' ),
						],
						[
							'title' 	=> esc_html__( 'Terms Of Coin Sale', 'cryptlux' ),
							'icon' 		=> esc_html__( 'fas fa-check', 'cryptlux' ),
						],
						[
							'title' 	=> esc_html__( 'Privaci & Policy', 'cryptlux' ),
							'icon' 		=> esc_html__( 'fas fa-check', 'cryptlux' ),
						],
						[
							'title' 	=> esc_html__( 'One Pager', 'cryptlux' ),
							'icon' 		=> esc_html__( 'fas fa-check', 'cryptlux' ),
						],
					],
					'title_field' => '{{{ title }}}',
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'icon_v2' 		=> esc_html__( 'ovaicomoon-bitcoin', 'cryptlux' ),
						],
						[
							'icon_v2' 		=> esc_html__( 'ovaicomoon-binance-coin', 'cryptlux' ),
						],
						[
							'icon_v2' 		=> esc_html__( 'ovaicomoon-paypal', 'cryptlux' ),
						],
						[
							'icon_v2' 		=> esc_html__( 'ovaicomoon-kyber-network', 'cryptlux' ),
						],
					],
					'condition' => [
						'type' 	=> 'v2',
			...
			$repeater->add_control(
				...
				[
					'label' 	=> esc_html__( 'Title', 'cryptlux' ),
					'type' 		=> Controls_Manager::TEXT,
					'default' 	=> esc_html__('Add Your Heading Text Here', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'icon_v3' 			=> esc_html__( 'ovaicomoon-shopping-cart', 'cryptlux' ),
							'title_v3' 			=> esc_html__( 'Online Buy & Sell', 'cryptlux' ),
							'description_v3' 	=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and.', 'cryptlux' ),
						],
						[
							'icon_v3' 			=> esc_html__( 'ovaicomoon-wallet-3', 'cryptlux' ),
							'title_v3' 			=> esc_html__( 'Manage your Wallet', 'cryptlux' ),
							'description_v3' 	=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and.', 'cryptlux' ),
						],
						[
							'icon_v3' 			=> esc_html__( 'ovaicomoon-people', 'cryptlux' ),
							'title_v3' 			=> esc_html__( 'Stay with Friend', 'cryptlux' ),
							'description_v3' 	=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and.', 'cryptlux' ),
						],
						[
							'icon_v3' 			=> esc_html__( 'ovaicomoon-receipt-disscount', 'cryptlux' ),
							'title_v3' 			=> esc_html__( 'Reward & Bonus', 'cryptlux' ),
							'description_v3' 	=> esc_html__( 'Lorem Ipsum is simply dummy text of the printing and.', 'cryptlux' ),
						],
					],
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				'icon_space_between',
				[
					'label' 	=> esc_html__( 'Row Gap', 'cryptlux' ),
			...
			$this->add_responsive_control(
				'icon_column_gap',
				[
					'label' 	=> esc_html__( 'Column Gap', 'cryptlux' ),
					'type' 		=> Controls_Manager::SLIDER,
					'range' => [
						'px' => [
							'min' => 0,
        ...
        $this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label' 	=> esc_html__( 'After', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'icon_before_v2' => 'yes',
		...
		$this->start_controls_section(
	        ...
	        $this->add_responsive_control(
				'items_v2_spacing',
				[
					'label' 	=> esc_html__( 'Spacing', 'cryptlux' ),
					'type' 		=> Controls_Manager::SLIDER,
					'range' 	=> [
						'px' 	=> [
							'min' => 0,
