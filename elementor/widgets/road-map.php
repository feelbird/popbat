...
class Cryptlight_Elementor_Road_Map extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Road Map', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_road_map',
			[
				'label' => esc_html__( 'Road Map', 'cryptlux' ),
			]
		);	
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'options' 	=> [
	                    ...
	                    'v4' => esc_html__( 'Type 4', 'cryptlux' ),
	                    'v5' => esc_html__( 'Type 5', 'cryptlux' ),
	                    'v6' => esc_html__( 'Type 6', 'cryptlux' ),
	                ],
	                'default' 	=> 'v1',
	            ]
	        );
	        ...
	        $repeater = new \Elementor\Repeater();
				...
				$repeater->add_control(
					...
					[
						...
						'default' 		=> esc_html__('In this time period, our Intelligent and talent founders had a concept of creating our ICO to call for investment', 'cryptlux' ),
					]
				);
				...
				$repeater->add_control(
					'timeline_done',
					[
						'label' 	=> esc_html__( 'Timeline Done', 'cryptlux' ),
				...
				$repeater->add_responsive_control(
					'animation_content',
					[
						'label' => esc_html__( 'Animation Content', 'cryptlux' ),
				...
				$repeater->add_control(
					...
					[
						'label' 	=> esc_html__( 'Animation Duration', 'cryptlux' ),
						'type' 		=> Controls_Manager::SELECT,
						'default' 	=> '',
						'options' 	=> [
							'slow' 	=> esc_html__( 'Slow', 'cryptlux' ),
							'' 		=> esc_html__( 'Normal', 'cryptlux' ),
							'fast' 	=> esc_html__( 'Fast', 'cryptlux' ),
						],
						'condition' => [
							'animation_content!' => '',
						],
				...
				$repeater->add_control(
					...
					[
						'label' 	=> esc_html__( 'Animation Delay', 'cryptlux' ) . ' (ms)',
				...
				[
					...
					'default' 	=> [
						[
							...
							'content' 			=> esc_html__('In this time period, our Intelligent and talent founders had a concept.', 'cryptlux' ),
							'timeline_done' 	=> 'yes',
						],
						[
							'date' 			=> esc_html__( '2021-05-01', 'cryptlux' ),
							'content' 		=> esc_html__('In this time period, our Intelligent and talent founders had a concept of.', 'cryptlux' ),
							'timeline_done' => 'yes',
						],
						[
						...
						[
							'date' 			=> esc_html__( '2021-01-01', 'cryptlux' ),
							'content' 		=> esc_html__('In this time period, our Intelligent and talent founders had a concept of.', 'cryptlux' ),
							'timeline_done' => 'no',
						],
					],
			...
			$this->add_control(
				'show_item_1',
				[
					'label' 	=> esc_html__( 'Show Item 1', 'cryptlux' ),
					'type' 		=> Controls_Manager::SWITCHER,
			...
			$repeater_1 = new \Elementor\Repeater();
				...
				$repeater_1->add_control(
					...
					[
						...
						'default' 	=> esc_html__( 'Concept', 'cryptlux' ),
					]
				);
				...
				$repeater_1->add_control(
					...
					[
						'label' 		=> esc_html__( 'Content', 'cryptlux' ),
						'type' 			=> Controls_Manager::TEXTAREA,
						'description' 	=> esc_html__( 'Separated by commas(,)', 'cryptlux' ),
						'default' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
					]
				);
				...
				$repeater_1->add_responsive_control(
					'animation_date_1',
					[
						'label' => esc_html__( 'Animation Date', 'cryptlux' ),
						'type' 	=> Controls_Manager::ANIMATION,
					]
				);
			...
			$this->add_control(
				'road_map_items_1',
				[
					'label' 	=> esc_html__( 'Items 1', 'cryptlux' ),
					'type' 		=> Controls_Manager::REPEATER,
					'fields' 	=> $repeater_1->get_controls(),
					'default' 	=> [
						[
							'date_1' 			=> esc_html__( '2021-01-01', 'cryptlux' ),
							'title_1' 			=> esc_html__( 'Concept', 'cryptlux' ),
							'content_1' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_1' 	=> 'yes',
						],
						[
							'date_1' 			=> esc_html__( '2021-03-01', 'cryptlux' ),
							'title_1' 			=> esc_html__( 'Research', 'cryptlux' ),
							'content_1' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_1' 	=> 'yes',
						],
						[
							'date_1' 			=> esc_html__( '2021-05-01', 'cryptlux' ),
							'title_1' 			=> esc_html__( 'Pre-Sale', 'cryptlux' ),
							'content_1' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_1' 	=> 'yes',
						],
					],
			...
			$this->add_control(
				'show_item_2',
				[
					'label' 	=> esc_html__( 'Show Item 2', 'cryptlux' ),
					'type' 		=> Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'cryptlux' ),
					'label_off' => esc_html__( 'Hide', 'cryptlux' ),
					'default' 	=> 'yes',
			...
			$repeater_2 = new \Elementor\Repeater();
				...
				$repeater_2->add_control(
					...
					[
						'label' 	=> esc_html__( 'Title', 'cryptlux' ),
						'type' 		=> Controls_Manager::TEXT,
						'default' 	=> esc_html__( 'App beta test', 'cryptlux' ),
					]
				);
			...
			$this->add_control(
				'road_map_items_2',
				[
					'label' 	=> esc_html__( 'Items 2', 'cryptlux' ),
					'type' 		=> Controls_Manager::REPEATER,
					'fields' 	=> $repeater_2->get_controls(),
					'default' 	=> [
						[
							'date_2' 			=> esc_html__( '2021-07-01', 'cryptlux' ),
							'title_2' 			=> esc_html__( 'App beta test', 'cryptlux' ),
							'content_2' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_2' 	=> 'yes',
						],
						[
							'date_2' 			=> esc_html__( '2021-09-01', 'cryptlux' ),
							'title_2' 			=> esc_html__( 'Token sale', 'cryptlux' ),
							'content_2' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_2' 	=> 'no',
						],
					],
			...
			$this->add_control(
				'show_item_3',
				[
					'label' 	=> esc_html__( 'Show Item 3', 'cryptlux' ),
					'type' 		=> Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'cryptlux' ),
					'label_off' => esc_html__( 'Hide', 'cryptlux' ),
					'default' 	=> 'yes',
			...
			$repeater_3 = new \Elementor\Repeater();
				...
				$repeater_3->add_control(
					...
					[
						'label' 	=> esc_html__( 'Title', 'cryptlux' ),
						'type' 		=> Controls_Manager::TEXT,
						'default' 	=> esc_html__( 'Alpha test', 'cryptlux' ),
					]
				);
			...
			$this->add_control(
				'road_map_items_3',
				[
					'label' 	=> esc_html__( 'Items 3', 'cryptlux' ),
					'type' 		=> Controls_Manager::REPEATER,
					'fields' 	=> $repeater_3->get_controls(),
					'default' 	=> [
						[
							'date_3' 			=> esc_html__( '2021-11-01', 'cryptlux' ),
							'title_3' 			=> esc_html__( 'Alpha test', 'cryptlux' ),
							'content_3' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_3' 	=> 'no',
						],
						[
							'date_3' 			=> esc_html__( '2022-01-01', 'cryptlux' ),
							'title_3' 			=> esc_html__( 'Benefits', 'cryptlux' ),
							'content_3' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_3' 	=> 'no',
						],
						[
							'date_3' 			=> esc_html__( '2022-03-01', 'cryptlux' ),
							'title_3' 			=> esc_html__( 'Operational', 'cryptlux' ),
							'content_3' 		=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_3' 	=> 'no',
						],
					],
			...
			$repeater_v3 = new \Elementor\Repeater();
				...
				$repeater_v3->add_control(
					'number_v3',
					[
						'label' 	=> esc_html__( 'Number', 'cryptlux' ),
						'type' 		=> Controls_Manager::TEXT,
						'default' 	=> esc_html__( '01.', 'cryptlux' ),
					]
				);
				...
				$repeater_v3->add_control(
					...
					[
						'label' 	=> esc_html__( 'Title', 'cryptlux' ),
						'type' 		=> Controls_Manager::TEXT,
						'default' 	=> esc_html__('Add Your Title', 'cryptlux' ),
					]
				);
				...
				$repeater_v3->add_control(
					...
					[
						...
						'type' 		=> Controls_Manager::TEXT,
						'default' 	=> esc_html__('Add Your Description', 'cryptlux' ),
					]
				);
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'icon_v3' 			=> esc_html__( 'ovaicomoon-cellphone', 'cryptlux' ),
							'number_v3' 		=> esc_html__( '01.', 'cryptlux' ),
							'title_v3' 			=> esc_html__( 'Mobie payment made easy', 'cryptlux' ),
							'description_v3' 	=> esc_html__( 'You can use a mobile device to pay with simple steps', 'cryptlux' ),
						],
						[
							'icon_v3' 			=> esc_html__( 'ovaicomoon-wallet', 'cryptlux' ),
							'number_v3' 		=> esc_html__( '02.', 'cryptlux' ),
							'title_v3' 			=> esc_html__( 'No transaction free', 'cryptlux' ),
							'description_v3' 	=> esc_html__( 'You can use a mobile device to pay with simple steps', 'cryptlux' ),
						],
						[
							'icon_v3' 			=> esc_html__( 'iconly-Shield-Done icbo', 'cryptlux' ),
							'number_v3' 		=> esc_html__( '03.', 'cryptlux' ),
							'title_v3' 			=> esc_html__( 'Protect the identity', 'cryptlux' ),
							'description_v3' 	=> esc_html__( 'You can use a mobile device to pay with simple steps', 'cryptlux' ),
						],
						[
							'icon_v3' 			=> esc_html__( 'iconly-Filter icbo', 'cryptlux' ),
							'number_v3' 		=> esc_html__( '04.', 'cryptlux' ),
							'title_v3' 			=> esc_html__( 'Security & control over money', 'cryptlux' ),
							'description_v3' 	=> esc_html__( 'You can use a mobile device to pay with simple steps', 'cryptlux' ),
						],
					],
			...
			$repeater_v4 = new \Elementor\Repeater();
				...
				$repeater_v4->add_control(
					'date_v4_from',
					[
						'label' 		=> esc_html__( 'From', 'cryptlux' ),
						'type' 			=> Controls_Manager::DATE_TIME,
				...
				$repeater_v4->add_control(
					...
					[
						'label' 		=> esc_html__( 'Title', 'cryptlux' ),
						'type' 			=> Controls_Manager::TEXT,
						'default' 		=> esc_html__('67%', 'cryptlux' ),
					]
				);
				...
				$repeater_v4->add_control(
					...
					[
						...
						'type' 			=> Controls_Manager::TEXT,
						'default' 		=> esc_html__('Discount', 'cryptlux' ),
					]
				);
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'date_v4_from' 	=> esc_html__( '2021-01-16', 'cryptlux' ),
							'date_v4_to' 	=> esc_html__( '2021-02-15', 'cryptlux' ),
							'title_v4' 		=> esc_html__( '67%', 'cryptlux' ),
							'text_v4' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
						[
							'date_v4_from' 	=> esc_html__( '2021-03-16', 'cryptlux' ),
							'date_v4_to' 	=> esc_html__( '2021-04-15', 'cryptlux' ),
							'title_v4' 		=> esc_html__( '50%', 'cryptlux' ),
							'text_v4' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
						[
							'date_v4_from' 	=> esc_html__( '2021-05-16', 'cryptlux' ),
							'date_v4_to' 	=> esc_html__( '2021-06-15', 'cryptlux' ),
							'title_v4' 		=> esc_html__( '40%', 'cryptlux' ),
							'text_v4' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
						[
							'date_v4_from' 	=> esc_html__( '2021-07-16', 'cryptlux' ),
							'date_v4_to' 	=> esc_html__( '2021-09-15', 'cryptlux' ),
							'title_v4' 		=> esc_html__( '20%', 'cryptlux' ),
							'text_v4' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
						[
							'date_v4_from' 	=> esc_html__( '2021-10-16', 'cryptlux' ),
							'date_v4_to' 	=> esc_html__( '2021-12-15', 'cryptlux' ),
							'title_v4' 		=> esc_html__( '15%', 'cryptlux' ),
							'text_v4' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
					],
					'condition'	=> [
			...
			$this->add_control(
				'seperate_v4',
				[
					'label' 	=> esc_html__( 'Seperate', 'cryptlux' ),
					'type' 		=> Controls_Manager::TEXT,
					'default' 	=> esc_html__( ' - ', 'cryptlux' ),
					'condition' => [
						'type' 	=> 'v4',
					],
				]
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'date_v5_from' 	=> esc_html__( '2021-01-16', 'cryptlux' ),
							'date_v5_to' 	=> esc_html__( '2021-02-15', 'cryptlux' ),
							'title_v5' 		=> esc_html__( '67%', 'cryptlux' ),
							'text_v5' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
						[
							'date_v5_from' 	=> esc_html__( '2021-03-16', 'cryptlux' ),
							'date_v5_to' 	=> esc_html__( '2021-04-15', 'cryptlux' ),
							'title_v5' 		=> esc_html__( '50%', 'cryptlux' ),
							'text_v5' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
						[
							'date_v5_from' 	=> esc_html__( '2021-05-16', 'cryptlux' ),
							'date_v5_to' 	=> esc_html__( '2021-06-15', 'cryptlux' ),
							'title_v5' 		=> esc_html__( '40%', 'cryptlux' ),
							'text_v5' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
						[
							'date_v5_from' 	=> esc_html__( '2021-07-16', 'cryptlux' ),
							'date_v5_to' 	=> esc_html__( '2021-09-15', 'cryptlux' ),
							'title_v5' 		=> esc_html__( '20%', 'cryptlux' ),
							'text_v5' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
						[
							'date_v5_from' 	=> esc_html__( '2021-10-16', 'cryptlux' ),
							'date_v5_to' 	=> esc_html__( '2021-12-15', 'cryptlux' ),
							'title_v5' 		=> esc_html__( '15%', 'cryptlux' ),
							'text_v5' 		=> esc_html__( 'Discount', 'cryptlux' ),
						],
					],
					'condition'	=> [
			...
			$this->add_responsive_control(
	            ...
	            [
	                ...
	                'options' 	=> [
	                    ...
	                    'space-between' => [
	                        'title' 	=> esc_html__( 'Between', 'cryptlux' ),
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'date_v6' 				=> esc_html__( '2021-03-01', 'cryptlux' ),
							'content_v6' 			=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_v6' 		=> 'yes',
						],
						[
							'date_v6' 				=> esc_html__( '2021-05-01', 'cryptlux' ),
							'content_v6' 			=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_v6' 		=> 'yes',
						],
						[
							'date_v6' 				=> esc_html__( '2021-07-01', 'cryptlux' ),
							'content_v6' 			=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_v6' 		=> 'yes',
						],
						[
							'date_v6' 				=> esc_html__( '2021-09-01', 'cryptlux' ),
							'content_v6' 			=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_v6' 		=> 'no',
						],
						[
							'date_v6' 				=> esc_html__( '2021-11-01', 'cryptlux' ),
							'content_v6' 			=> esc_html__('Concept Generation,Team Assemble', 'cryptlux' ),
							'timeline_done_v6' 		=> 'no',
						],
					],
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'date_color_not_done',
				[
					'label' 	=> esc_html__( 'Color Not Done', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'line_color',
				[
					'label' 	=> esc_html__( 'Line Color', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'line_color_not_done',
				[
					'label' 	=> esc_html__( 'Line Color Not Done', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_responsive_control(
				'line_width',
				[
					'label' 	=> esc_html__( 'Line Width', 'cryptlux' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'icon_not_done_bg',
				[
					'label' 	=> esc_html__( 'Background Not Done', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'icon_not_done_bg_in',
				[
					'label' 	=> esc_html__( 'Background Not Done In', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
	        ...
	        $this->add_control(
				'line_options',
				[
					'label' 	=> esc_html__( 'Line Options', 'cryptlux' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Border Right Option', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                    'type' 	=> 'v1',
	        ...
	        $this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Color Right Not Done', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
	        ...
	        $this->add_control(
	            ...
	            [
	                'label' 		=> esc_html__( 'Border Right Radius', 'cryptlux' ),
	                'type' 			=> Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%' ],
	                'selectors' 	=> [
	        ...
	        $this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Border Left Option', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                    'type' 	=> 'v1',
	        ...
	        $this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Color Left Not Done', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
	        ...
	        $this->add_control(
	            ...
	            [
	                'label' 		=> esc_html__( 'Border Left Radius', 'cryptlux' ),
	                'type' 			=> Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%' ],
	                'selectors' 	=> [
			...
			$this->add_control(
				'title_color',
				[
					'label' 	=> esc_html__( 'Title Color', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_responsive_control(
	            'title_margin',
	            [
	                'label' 		=> esc_html__( 'Title Margin', 'cryptlux' ),
	                'type' 			=> Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
	        ...
	        $this->add_responsive_control(
				'item_spacing',
				[
					'label' 	=> esc_html__( 'Space Between Item', 'cryptlux' ),
					'type' 		=> Controls_Manager::SLIDER,
					'range' 	=> [
						'px' 	=> [
							'min' => 0,
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Item Before Desktop', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
			...
			$this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Item Before Mobile', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'date_v4_before',
				[
					'label' 	=> esc_html__( 'Before Options', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label' 		=> esc_html__( 'Linear Gradient', 'cryptlux' ),
					'type' 			=> Controls_Manager::SWITCHER,
					'label_on' 		=> esc_html__( 'Show', 'cryptlux' ),
					'label_off' 	=> esc_html__( 'Hide', 'cryptlux' ),
					'default' 		=> 'no',
					'description' 	=> esc_html__( 'Title background linear Gradient', 'cryptlux' ),
				]
			);
		...
		$this->start_controls_section(
			'content_v6_style',
			[
				'label' 	=> esc_html__( 'Content Desktop', 'cryptlux' ),
				'tab'   	=> Controls_Manager::TAB_STYLE,
				'condition' => [
					'type' 	=> 'v6',
				],
		...
		$this->start_controls_section(
			...
			[
				'label' 	=> esc_html__( 'Content Mobile', 'cryptlux' ),
				'tab'   	=> Controls_Manager::TAB_STYLE,
				'condition' => [
					'type' 	=> 'v6',
				],
