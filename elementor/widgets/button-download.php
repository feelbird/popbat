...
class Cryptlight_Elementor_Button_Download extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Button Download', 'cryptlux' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> esc_html__( 'Dowload', 'cryptlux' ),
				]
			);
			...
			$repeater->add_control(
				'language',
				[
					'label' 	=> esc_html__( 'Language', 'cryptlux' ),
					'type' 		=> Controls_Manager::TEXT,
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'language' 	=> esc_html__( 'English', 'cryptlux' ),
							'link' 		=> [ 'url' =>  esc_html__( '#', 'cryptlux' ) ],
						],
						[
							'language' 	=> esc_html__( 'French', 'cryptlux' ),
							'link' 		=> [ 'url' =>  esc_html__( '#', 'cryptlux' ) ],
						],
						[
							'language' 	=> esc_html__( 'German', 'cryptlux' ),
							'link' 		=> [ 'url' =>  esc_html__( '#', 'cryptlux' ) ],
						],
					],
