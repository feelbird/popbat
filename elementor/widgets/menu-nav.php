...
class Cryptlight_Elementor_Menu_Nav extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_menu_type',
			[
				'label' => esc_html__( 'Global', 'cryptlux' ),
			]
		);
			...
			$this->add_control(
				'menu_slug',
				[
					'label' 		=> esc_html__( 'Select Menu', 'cryptlux' ),
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Parent Menu', 'cryptlux' ),
			]
		);
			...
			$this->add_control(
				'link_color_hover',
				[
					'label' 	=> esc_html__( 'Link Hover', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'default' 	=> '',
					'selectors' => [
			...
			$this->add_control(
				'link_color_active',
				[
					'label' 	=> esc_html__( 'Link Active', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'default' 	=> '',
					'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sub Menu', 'cryptlux' ),
			]
		);	
			...
			$this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Background Item Hover', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'default' 	=> '',
					'selectors' => [
		...
		$this->start_controls_section(
            'menu_style',
            [
                'label' => esc_html__( 'Menu', 'cryptlux' ),
			...
			$this->add_responsive_control(
	            ...
	            [
	                ...
	                'options' 	=> [
	                    'inline-block' 	=> [
	                        'title' 	=> esc_html__( 'Default', 'cryptlux' ),
	                        'icon' 		=> 'eicon-editor-list-ul',
	                    ],
	                    'block' 		=> [
	                        'title' 	=> esc_html__( 'Inline', 'cryptlux' ),
	...
	protected function render() {
		...
		<nav class="main-navigation">
            <button class="menu-toggle">
            	<span>
            		<?php echo esc_html__( 'Menu', 'cryptlux' ); ?>
            	</span>
            </button>
			<?php
				wp_nav_menu( [
