...
class Cryptlight_Elementor_Sale_Token extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Sale Token', 'cryptlux' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'row' => 5,
					'default' => esc_html__('Jan 15 - Feb 15','cryptlux'),
				]
			);
			...
			$this->add_control(
				'bonus',
				[
					'label' => esc_html__( 'Bonus', 'cryptlux' ),
					'type' => Controls_Manager::TEXTAREA,
					'row' => 5,
					'default' => esc_html__('67% Bonus','cryptlux'),
				]
			);
			$this->add_control(
				'price',
				[
					'label' => esc_html__( 'Price', 'cryptlux' ),
					'type' => Controls_Manager::TEXTAREA,
					'row' => 5,
					'default' => esc_html__('$0.9009/token','cryptlux'),
				]
			);
