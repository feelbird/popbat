...
class Cryptlight_Elementor_Choice_Language extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Choice Language', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'current_lang',
				[
					'label' => esc_html__( 'Current Language', 'cryptlux' ),
			...
			$this->add_control(
				'flag_title',
				[
					'label' 	=> esc_html__( 'Nation', 'cryptlux' ),
					'type' 		=> Controls_Manager::TEXT,
					'default' 	=> esc_html__( 'EN', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				'dropdown_lang',
				[
					'label' => esc_html__( 'Dropdown Language', 'cryptlux' ),
					'type' 	=> Controls_Manager::HEADING,
				]
			);
		...
		$this->start_controls_section(
	        ...
	        $this->add_control(
	            ...
	            [
	                'label' 		=> esc_html__( 'Border Radius Hover', 'cryptlux' ),
	                'type' 			=> Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%' ],
	                'selectors' 	=> [
