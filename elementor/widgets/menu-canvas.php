...
class Cryptlight_Elementor_Canvas_Menu extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu Canvas', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'menu_dir',
				[
					'label' => esc_html__( 'Menu Direction', 'cryptlux' ),
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Style', 'cryptlux' ),
			]
		);
			...
			$this->add_control(
				'bg_color',
				[
					'label' => esc_html__( 'Menu Background', 'cryptlux' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
