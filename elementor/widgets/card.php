...
class Cryptlight_Elementor_Card extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Card', 'cryptlux' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> esc_html__( 'ovaicon-page-blank', 'cryptlux' ),
	        ...
	        $this->add_responsive_control(
				'icon_position',
				[
					'label' 	=> esc_html__( 'Icon Position', 'cryptlux' ),
			...
			$this->add_control(
				...
				[
					...
					'row' 		=> 5,
					'default' 	=> esc_html__('You can use a mobile device to pay with simple steps','cryptlux'),
				]
			);
