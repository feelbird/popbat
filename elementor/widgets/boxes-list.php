...
class Cryptlight_Elementor_Boxes_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Boxes List', 'cryptlux' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'from' 			=> esc_html__( '2021-03-15', 'cryptlux' ),
							'to' 			=> esc_html__( '2021-09-15', 'cryptlux' ),
							'title' 		=> esc_html__('67% bonus', 'cryptlux' ),
							'description' 	=> esc_html__('$0.9009/token', 'cryptlux' ),
						],
						[
							'from' 			=> esc_html__( '2021-03-15', 'cryptlux' ),
							'to' 			=> esc_html__( '2021-09-15', 'cryptlux' ),
			...
			$this->add_control(
				'seperate',
				[
					'label' 		=> esc_html__( 'Seperate Date', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
