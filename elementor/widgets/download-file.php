...
class Cryptlight_Elementor_Download_File extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Download File', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'image',
				[
					'label' 	=> esc_html__( 'Choose Image', 'cryptlux' ),
			...
			$this->add_control(
				...
				[
					...
					'default' 		=> esc_html__( 'White paper', 'cryptlux' ),
					'placeholder'	=> esc_html__( 'Type your title here', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( '-2021-', 'cryptlux' ),
					'placeholder'	=> esc_html__( 'Type your description here', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'iconly-Download icbo', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				'text_language',
				[
					'label' 		=> esc_html__( 'Language Text', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( '(English)', 'cryptlux' ),
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				$this->add_control(
					'show_before',
					[
						'label' 	=> esc_html__( 'Show Before', 'cryptlux' ),
		    ...
		    $this->add_control(
				...
				$this->add_control(
					'show_after',
					[
						'label' 	=> esc_html__( 'Show After', 'cryptlux' ),
						'type' 		=> Controls_Manager::SWITCHER,
						'label_on' 	=> esc_html__( 'Show', 'cryptlux' ),
						'label_off' => esc_html__( 'Hide', 'cryptlux' ),
						'default' 	=> 'yes',
		...
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Button Icon', 'cryptlux' ),
                'tab' 	=> Controls_Manager::TAB_STYLE,
            ]
        );
	...
	protected function render() {
		...
		$alt 			= isset( $settings['image']['alt'] ) ? $settings['image']['alt'] : esc_html( 'image', 'cryptlux' );

		if ( ! $alt ) {
			$alt = $settings['title'] ? $settings['title'] : esc_html( 'image', 'cryptlux' );
		}
