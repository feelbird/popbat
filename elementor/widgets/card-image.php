...
class Cryptlight_Elementor_Card_Image extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Card Image', 'cryptlux' );
	}
	            ...
	            [
	                ...
	                'default' 	=> [
	                    [	
	                        ...
	                        'title' => esc_html__( 'Timestamp server','cryptlux' ),
	                        'desc' 	=> esc_html__( 'The timestamp server is top notch','cryptlux' ),
	                    ],
	                    [	
	                    	'image' => [ 'url' => Elementor\Utils::get_placeholder_image_src(), ],
	                        'title' => esc_html__( 'Reclaiming disk space','cryptlux' ),
	                        'desc' 	=> esc_html__( 'Remove old transactions','cryptlux' ),
	                    ],
	                    [	
	                    	'image' => [ 'url' => Elementor\Utils::get_placeholder_image_src(), ],
	                        'title' => esc_html__( 'Simplified payment verification','cryptlux' ),
	                        'desc' 	=> esc_html__( 'verify payment without running a full node','cryptlux' ),
	                    ],
	                    [	
	                    	'image' => [ 'url' => Elementor\Utils::get_placeholder_image_src(), ],
	                        'title' => esc_html__( 'Combining and splitting value','cryptlux' ),
	                        'desc' 	=> esc_html__( 'Make a separate transaction','cryptlux' ),
	                    ],
	                ],
	                'title_field' => '{{{ title }}}',
	            ]
