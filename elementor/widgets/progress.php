...
class Cryptlight_Elementor_Progress extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Progress', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_progress',
			[
				'label' => esc_html__( 'Progress', 'cryptlux' ),
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'placeholder' 	=> esc_html__( 'Enter your title', 'cryptlux' ),
					'default' 		=> esc_html__( 'My Skill', 'cryptlux' ),
					'label_block' 	=> true,
					'condition'		=> [
						'type' 		=> 'v1',
					],
			...
			$this->add_control(
				'title_left',
				[
					'label' 		=> esc_html__( 'Title Left', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'placeholder' 	=> esc_html__( 'Enter your title', 'cryptlux' ),
					'default' 		=> esc_html__( 'Raised - ', 'cryptlux' ),
					'label_block' 	=> true,
					'condition'		=> [
						'type' 		=> 'v2',
					],
			...
			$this->add_control(
				'sub_title_left',
				[
					'label' 		=> esc_html__( 'Sub-Title Left', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'placeholder' 	=> esc_html__( 'Enter your title', 'cryptlux' ),
					'default' 		=> esc_html__( '1,450 Tokens', 'cryptlux' ),
					'label_block' 	=> true,
					'condition'		=> [
						'type' 		=> 'v2',
					],
			...
			$this->add_control(
				'title_right',
				[
					'label' 		=> esc_html__( 'Title Right', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'placeholder' 	=> esc_html__( 'Enter your title', 'cryptlux' ),
					'default' 		=> esc_html__( 'Target - ', 'cryptlux' ),
					'label_block' 	=> true,
					'condition'		=> [
						'type' 		=> 'v2',
					],
			...
			$this->add_control(
				'sub_title_right',
				[
					'label' 		=> esc_html__( 'Sub-Title Right', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'placeholder' 	=> esc_html__( 'Enter your title', 'cryptlux' ),
					'default' 		=> esc_html__( '150,000 Tokens', 'cryptlux' ),
					'label_block' 	=> true,
					'condition'		=> [
						'type' 		=> 'v2',
					],
			...
			$this->add_control(
	            'show_title',
	            [
	                'label' 	=> esc_html__( 'Show Title', 'cryptlux' ),
			...
			$this->add_control(
				'percent',
				[
					'label' 	=> esc_html__( 'Percent', 'cryptlux' ),
			...
			$this->add_control(
	            'show_percent',
	            [
	                'label' 	=> esc_html__( 'Show Percent', 'cryptlux' ),
	                'type' 		=> Controls_Manager::SWITCHER,
	                'default' 	=> 'yes',
	                'condition'	=> [
						'type' 	=> 'v1',
	        ...
	        $this->add_control(
	            'show_point',
	            [
	                'label' 	=> esc_html__( 'Show Point', 'cryptlux' ),
	                'type' 		=> Controls_Manager::SWITCHER,
	                'default' 	=> 'yes',
	                'condition'	=> [
						'type' 	=> 'v2',
	        ...
	        $this->add_control(
	            'show_notes',
	            [
	                'label' 	=> esc_html__( 'Show Notes', 'cryptlux' ),
	                'type' 		=> Controls_Manager::SWITCHER,
	                'default' 	=> 'no',
	                'separator' => 'before',
	            ]
	        ...
	        $repeater->add_control(
	            'item_color',
	            [
	                'label' 	=> esc_html__( 'Item Color', 'cryptlux' ),
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' 	=> [
	                    [
	                        'item_text' 	=> esc_html__( 'Pre Sale', 'cryptlux' ),
	                    ],
	                    [
	                        'item_text' 	=> esc_html__( 'Soft Cap', 'cryptlux' ),
	                    ],
	                    [
	                        'item_text' 	=> esc_html__( 'Bonus', 'cryptlux' ),
	                    ],
	                ],
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'default' 	=> [
	                    [
	                        'item_text_v2' 	=> esc_html__( 'Soft cap', 'cryptlux' ),
	                    ],
	                    [
	                        'item_text_v2' 	=> esc_html__( 'Crowdsale', 'cryptlux' ),
	                    ],
	                    [
	                        'item_text_v2' 	=> esc_html__( 'Hard cap', 'cryptlux' ),
	                    ],
	                ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Progress Bar', 'cryptlux' ),
			...
			$this->add_responsive_control(
	            'title_alignment',
	            [
	                'label' 	=> esc_html__( 'Alignment List', 'cryptlux' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'point_options',
				[
					'label' 	=> esc_html__( 'Point Options', 'cryptlux' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'sub_title_options',
				[
					'label' 	=> esc_html__( 'Sub Title', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                	'type' 	=> 'v2',
			...
			$this->add_control(
				'sub_title_color_v2',
				[
					'label' 	=> esc_html__( 'Sub Color', 'cryptlux' ),
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Percentage', 'cryptlux' ),
				'tab' 	=> Controls_Manager::TAB_STYLE,
				'condition' => [
                	'type' 	=> 'v1',
                ],
		...
		$this->start_controls_section(
			'section_note_style',
			[
				'label' => esc_html__( 'Notes', 'cryptlux' ),
				'tab' 	=> Controls_Manager::TAB_STYLE,
			]
		);
	        ...
	        $this->add_responsive_control(
	            'note_item_margin',
	            [
	                'label' 		=> esc_html__( 'Margin Item', 'cryptlux' ),
	                'type' 			=> Controls_Manager::DIMENSIONS,
	                'size_units' 	=> [ 'px', '%', 'em' ],
	                'selectors' 	=> [
