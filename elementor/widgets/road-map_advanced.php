...
class Cryptlight_Elementor_Road_Map_Advanced extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Road Map Advanced', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Road Map Advanced', 'cryptlux' ),
			]
		);	
			...
			$repeater->add_control(
				...
				[
					...
					'description' 	=> esc_html__('Items are separated by semicolons(;)', 'cryptlux' ),
				]
			);
				...
				[
					...
					'default' 	=> [
						[
							...
							'title' 	=> esc_html__( 'Concept', 'cryptlux' ),
							'done' 		=> 'yes',
							'content' 	=> esc_html__( 'Concept Generation;Team Assemble', 'cryptlux' ),
						],
						[
							'date' 		=> esc_html__( '2021-03-01', 'cryptlux' ),
							'icon'		=> esc_html__('fas fa-check', 'cryptlux' ),
							'title' 	=> esc_html__( 'Research', 'cryptlux' ),
							'done' 		=> 'yes',
							'content' 	=> esc_html__( 'Concept Generation;Team Assemble', 'cryptlux' ),
						],
						[
							...
							'icon'		=> esc_html__('fas fa-check', 'cryptlux' ),
							'title' 	=> esc_html__( 'Pre-Sale', 'cryptlux' ),
							'done' 		=> 'yes',
							'content' 	=> esc_html__( 'Concept Generation;Team Assemble', 'cryptlux' ),
						],
						[
							...
							'icon'		=> esc_html__('fas fa-check', 'cryptlux' ),
							'title' 	=> esc_html__( 'App beta test', 'cryptlux' ),
							'done' 		=> 'no',
							'content' 	=> esc_html__( 'Concept Generation;Team Assemble', 'cryptlux' ),
						],
						[
							...
							'icon'		=> esc_html__('fas fa-check', 'cryptlux' ),
							'title' 	=> esc_html__( 'Token sale', 'cryptlux' ),
							'done' 		=> 'no',
							'content' 	=> esc_html__( 'Concept Generation;Team Assemble', 'cryptlux' ),
						],
						[
							...
							'icon'		=> esc_html__('fas fa-check', 'cryptlux' ),
							'title' 	=> esc_html__( 'Alpha test', 'cryptlux' ),
							'done' 		=> 'no',
							'content' 	=> esc_html__( 'Concept Generation;Team Assemble', 'cryptlux' ),
						],
						[
							...
							'icon'		=> esc_html__('fas fa-check', 'cryptlux' ),
							'title' 	=> esc_html__( 'Benefits', 'cryptlux' ),
							'done' 		=> 'no',
							'content' 	=> esc_html__( 'Concept Generation;Team Assemble', 'cryptlux' ),
						],
						[
							...
							'icon'		=> esc_html__('fas fa-check', 'cryptlux' ),
							'title' 	=> esc_html__( 'Operational', 'cryptlux' ),
							'done' 		=> 'no',
							'content' 	=> esc_html__( 'Concept Generation;Team Assemble', 'cryptlux' ),
						],
        	...
        	$this->start_controls_tabs( 'tabs_icon_style' );
				...
				$this->start_controls_tab(
			        ...
			        $this->add_control(
			            ...
			            [
			                'label' 	=> esc_html__( 'Background Dots', 'cryptlux' ),
			                'type' 		=> Controls_Manager::COLOR,
			                'selectors' => [
			        ...
			        $this->add_control(
			            ...
			            [
			                'label' 	=> esc_html__( 'Mobile Line Color', 'cryptlux' ),
			                'type' 		=> Controls_Manager::COLOR,
			                'selectors' => [
		...
		$this->start_controls_section(
        	...
        	$this->add_control(
				...
				[
					'label' => esc_html__( 'Only in Desktop', 'cryptlux' ),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'text_style_mobile',
				[
					'label' 	=> esc_html__( 'Only in Mobile', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
				]
			);
