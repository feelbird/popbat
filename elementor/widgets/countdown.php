...
class Cryptlight_Elementor_CountDown extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Countdown', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_countdown',
			[
				'label' => esc_html__( 'Countdown', 'cryptlux' ),
			]
		);	
			...
			$this->add_control(
				...
				[
					...
					'options' 	=> [
						'due_date' 	=> esc_html__( 'Due Date', 'cryptlux' ),
						'evergreen' => esc_html__( 'Evergreen Timer', 'cryptlux' ),
					],
					'default' => 'due_date',
				]
			);
			...
			$this->add_control(
				'due_date',
				[
					'label' 		=> esc_html__( 'Due Date', 'cryptlux' ),
			...
			$this->add_control(
				'countdown_format',
				[
					'label' 	=> esc_html__( 'Format', 'cryptlux' ),
					'type' 		=> Controls_Manager::SELECT,
					'options' 	=> [
						'DHMS' 	=> esc_html__( 'Show', 'cryptlux' ),
						'dhms' 	=> esc_html__( 'Hide', 'cryptlux' ),
					],
					'default' 	=> 'DHMS',
					'description' => esc_html__( 'Show/Hide if time = 0.', 'cryptlux' ),
				]
			);
			...
			$this->add_control(
				...
				[
					'label' 		=> esc_html__( 'Hours', 'cryptlux' ),
					'type' 			=> Controls_Manager::NUMBER,
					'default' 		=> 69,
					'placeholder' 	=> esc_html__( 'Hours', 'cryptlux' ),
					'condition' 	=> [
			...
			$this->add_control(
				...
				[
					'label' 		=> esc_html__( 'Minutes', 'cryptlux' ),
					'type' 			=> Controls_Manager::NUMBER,
					'default' 		=> 96,
					'placeholder' 	=> esc_html__( 'Minutes', 'cryptlux' ),
					'condition' 	=> [
						'countdown_type' => 'evergreen',
					],
				]
			...
			$this->add_control(
				'show_days',
				[
					'label' 	=> esc_html__( 'Days', 'cryptlux' ),
			...
			$this->add_control(
				'show_seconds',
				[
					'label' 	=> esc_html__( 'Seconds', 'cryptlux' ),
					'type' 		=> Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'cryptlux' ),
					'label_off' => esc_html__( 'Hide', 'cryptlux' ),
					'default' 	=> 'yes',
			...
			$this->add_control(
				'show_labels',
				[
					'label' 	=> esc_html__( 'Show Label', 'cryptlux' ),
					'type' 		=> Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'cryptlux' ),
					'label_off' => esc_html__( 'Hide', 'cryptlux' ),
					'default' 	=> 'yes',
			...
			$this->add_responsive_control(
	            ...
	            [
	                ...
	                'options' 	=> [
	                    'top' 	=> [
	                        'title' => esc_html__( 'Top', 'cryptlux' ),
	                        'icon' 	=> 'eicon-v-align-top',
	                    ],
	                    'bottom' => [
	                        'title' => esc_html__( 'Bottom', 'cryptlux' ),
			...
			$this->add_control(
				'custom_labels',
				[
					'label' 	=> esc_html__( 'Custom Label', 'cryptlux' ),
					'type' 		=> Controls_Manager::SWITCHER,
					'condition' => [
						'show_labels!' => '',
					],
			...
			$this->add_control(
				'label_day',
				[
					'label' 		=> esc_html__( 'Day', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'Day', 'cryptlux' ),
					'placeholder' 	=> esc_html__( 'Day', 'cryptlux' ),
					'condition' 	=> [
						'show_labels!' 		=> '',
						'custom_labels!' 	=> '',
						'show_days' 		=> 'yes',
			...
			$this->add_control(
				...
				[
					'label' 		=> esc_html__( 'Days', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'Days', 'cryptlux' ),
					'placeholder' 	=> esc_html__( 'Days', 'cryptlux' ),
					'condition' 	=> [
						'show_labels!' 		=> '',
						'custom_labels!' 	=> '',
						'show_days' 		=> 'yes',
			...
			$this->add_control(
				'label_hour',
				[
					'label' 		=> esc_html__( 'Hour', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'Hour', 'cryptlux' ),
					'placeholder' 	=> esc_html__( 'Hour', 'cryptlux' ),
					'condition' 	=> [
						'show_labels!' 		=> '',
						'custom_labels!' 	=> '',
						'show_hours' 		=> 'yes',
			...
			$this->add_control(
				...
				[
					'label' 		=> esc_html__( 'Hours', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'Hours', 'cryptlux' ),
					'placeholder' 	=> esc_html__( 'Hours', 'cryptlux' ),
					'condition' 	=> [
						'show_labels!' 		=> '',
						'custom_labels!' 	=> '',
			...
			$this->add_control(
				'label_minute',
				[
					'label' 		=> esc_html__( 'Minute', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'Minute', 'cryptlux' ),
					'placeholder' 	=> esc_html__( 'Minute', 'cryptlux' ),
					'condition' 	=> [
						'show_labels!' 		=> '',
						'custom_labels!' 	=> '',
						'show_minutes' 		=> 'yes',
			...
			$this->add_control(
				...
				[
					'label' 		=> esc_html__( 'Minutes', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'Minutes', 'cryptlux' ),
					'placeholder' 	=> esc_html__( 'Minutes', 'cryptlux' ),
					'condition' 	=> [
						'show_labels!' 		=> '',
						'custom_labels!' 	=> '',
			...
			$this->add_control(
				'label_second',
				[
					'label' 		=> esc_html__( 'Second', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'Second', 'cryptlux' ),
					'placeholder' 	=> esc_html__( 'Second', 'cryptlux' ),
					'condition' 	=> [
						'show_labels!' 		=> '',
						'custom_labels!' 	=> '',
						'show_seconds' 		=> 'yes',
			...
			$this->add_control(
				...
				[
					'label' 		=> esc_html__( 'Seconds', 'cryptlux' ),
					'type' 			=> Controls_Manager::TEXT,
					'default' 		=> esc_html__( 'Seconds', 'cryptlux' ),
					'placeholder' 	=> esc_html__( 'Seconds', 'cryptlux' ),
					'condition' 	=> [
						'show_labels!' 		=> '',
						'custom_labels!' 	=> '',
						'show_seconds' 		=> 'yes',
			...
			$this->add_control(
				'expire_actions',
				[
					'label' 	=> esc_html__( 'Actions After Expire', 'cryptlux' ),
					'type' 		=> Controls_Manager::SELECT,
					'options' 	=> [
						'nothing' 	=> esc_html__( 'Nothing', 'cryptlux' ),
						'hide' 		=> esc_html__( 'Hide', 'cryptlux' ),
						'redirect' 	=> esc_html__( 'Redirect', 'cryptlux' ),
						'message' 	=> esc_html__( 'Show Message', 'cryptlux' ),
					],
				]
			);
			...
			$this->add_control(
				...
				[
					'label' 	=> esc_html__( 'Message', 'cryptlux' ),
					'type' 		=> Controls_Manager::TEXTAREA,
					'separator' => 'before',
					'dynamic' 	=> [
						'active' => true,
					],
					'default'	=> esc_html__( 'Countdown timeout', 'cryptlux' ),
					'condition' => [
			...
			$this->add_control(
				'expire_redirect_url',
				[
					'label' 	=> esc_html__( 'Redirect URL', 'cryptlux' ),
		...
		$this->start_controls_section(
	        ...
	        $this->add_control(
				'show_content_before',
				[
					'label' 	=> esc_html__( 'Before', 'cryptlux' ),
					'type' 		=> Controls_Manager::SWITCHER,
					'label_on' 	=> esc_html__( 'Show', 'cryptlux' ),
					'label_off' => esc_html__( 'Hide', 'cryptlux' ),
					'default' 	=> 'no',
			...
			$this->add_control(
				...
				[
					'label' 	=> esc_html__( 'After Options', 'cryptlux' ),
					'type' 		=> Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
						'show_content_before' => 'yes',
		...
		$this->start_controls_section(
            'boxes_style',
            [
                'label' => esc_html__( 'Boxes', 'cryptlux' ),
                'tab' 	=> Controls_Manager::TAB_STYLE,
            ]
        );
		...
		$this->start_controls_section(
            'labels_style',
            [
                'label' => esc_html__( 'Labels', 'cryptlux' ),
                'tab' 	=> Controls_Manager::TAB_STYLE,
            ]
        );
