...
class Cryptlight_Elementor_Chart extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Chart', 'cryptlux' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_charts',
			[
				'label' => esc_html__( 'Charts', 'cryptlux' ),
			]
		);	
			...
			$this->add_control(
	            ...
	            [
	                ...
	                'options' 	=> [
	                    'doughnut' 	=> esc_html__( 'Doughnut', 'cryptlux' ),
	                    'pie' 		=> esc_html__( 'Pie', 'cryptlux' ),
	                ],
	                'default' 	=> 'doughnut',
	            ]
	        );
	        ...
	        $this->add_control(
	            'chart_id',
	            [
	                'label' 		=> esc_html__( 'Chart ID', 'cryptlux' ),
	                'type' 			=> Controls_Manager::TEXT,
	                'default' 		=> 'chart_unique_id',
	                'description' 	=> esc_html__( 'Add unique ID for chart.', 'cryptlux' ),
	            ]
	        );
	        ...
	        $this->add_control(
	            'chart_radius',
	            [
	                'label' 	=> esc_html__( 'Chart Radius', 'cryptlux' ),
	        ...
	        $this->add_control(
	            'chart_border_width',
	            [
	                'label' 	=> esc_html__( 'Chart Border Width', 'cryptlux' ),
	                'type' 		=> Controls_Manager::NUMBER,
	                'min' 		=> 0,
	                'max' 		=> 100,
	                'step' 		=> 1,
	        ...
	        $this->add_control(
				'chart_canvas',
				[
					'label' 	=> esc_html__( 'Canvas', 'cryptlux' ),
			...
			$this->add_control(
	            'canvas_size',
	            [
	                'label' 	=> esc_html__( 'Canvas Size', 'cryptlux' ),
	                'type' 		=> Controls_Manager::NUMBER,
	                'min' 		=> 0,
	                'max' 		=> 1000,
	                'step' 		=> 5,
	        ...
	        $this->add_control(
	            'canvas_background',
	            [
	                'label' 	=> esc_html__( 'Canvas Background', 'cryptlux' ),
	                'type' 		=> Controls_Manager::COLOR,
	                'condition' => [
	                	'chart_canvas' => 'yes',
	                ],
	        ...
	        $repeater = new \Elementor\Repeater();
				...
				$repeater->add_control(
					'label',
					[
						'label' 	=> esc_html__( 'Label', 'cryptlux' ),
						'type' 		=> Controls_Manager::TEXT,
						'default'	=> esc_html__( 'Marketing', 'cryptlux' ),
					]
				);
			...
			$this->add_control(
				...
				[
					...
					'default' 	=> [
						[
							'label' 	=> esc_html__( 'Contingency', 'cryptlux' ),
							'percent' 	=> 5,
							'color' 	=> '#3D88FB',
						],
						[
							'label' 	=> esc_html__( 'Partner/Investor', 'cryptlux' ),
							'percent' 	=> 5,
							'color' 	=> '#5637C8',
						],
						[
							'label' 	=> esc_html__( 'Legal & Regulation', 'cryptlux' ),
							'percent' 	=> 10,
							'color' 	=> '#00D89E',
						],
						[
							'label' 	=> esc_html__( 'Business Development', 'cryptlux' ),
							'percent' 	=> 10,
							'color' 	=> '#ACDF35',
						],
						[
							'label' 	=> esc_html__( 'Operational', 'cryptlux' ),
							'percent' 	=> 10,
							'color' 	=> '#9116CD',
						],
						[
							'label' 	=> esc_html__( 'Product Develoment', 'cryptlux' ),
							'percent' 	=> 40,
							'color' 	=> '#FC3352',
						],
						[
							'label' 	=> esc_html__( 'Marketing', 'cryptlux' ),
							'percent' 	=> 20,
							'color' 	=> '#FF9B5C',
						],
					],
